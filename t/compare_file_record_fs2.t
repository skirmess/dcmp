...
sub main {
    ...
    *App::DCMP::binmode = sub { return };
    ...
    for my $suffix (@suffixes) {
        ...
        like(
            exception { App::DCMP::_compare_file_record_fs( $chdir, \@dirs, $file, undef, undef ) },
            encode( 'UTF-8', "/ ^ \Qbinmode failed for $file: \E /xsm" ), '_collect_file_info_report throws an exception if binmode failes'
        );
