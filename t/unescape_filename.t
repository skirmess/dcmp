...
sub main {
    ...
    for my $test_result ( sort keys %test ) {
        my $test_input = $test{$test_result};
        is( App::DCMP::_unescape_filename($test_input), $test_result, encode( 'UTF-8', "File name: $test_input" ) );
    }
